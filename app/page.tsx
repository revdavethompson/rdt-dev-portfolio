...
export default function Home() {
  return (
    ...
    <center>
        <div className="text col-sm-6" style="margin-top: 140px;">Hi <span className="wave"><img src="assets/images/Hand.gif"
                    width="35px"></span>&nbsp;<br />I'm <span className="fs-1">Dave</span>
            <div className="center">
                <div>
                    <img src="assets/images/rdt-avatar.svg" alt="" className="rounded-circle bg-white" height="200"
                        width="200">
                </div>
                <br />
                <span style="display: inline;">I like <span className="animated-text"
                        data-words="Web Design, UI/UX, Hiking, Web Site/App Development, Web Development, JS/React/NextJS, Playing PIano (Rachmoninov/Chopin), Open Source Anything, Fly-fishing rivers, Mentoring"></span>
                </span>
                <div>
                    <div className="social-icons">

                        <a className="socialicon twitter" href="" target="_blank" rel="author">
                            <svg className="twitter-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500"
                                enable-background="new 0 0 500 500" xml:space="preserve">
                                <path id="body" fill="#8B5CF6"
                        ...
                        <a className="socialicon dribbble" href="" target="_blank" rel="author">
                            <svg className="dribbble-icon" viewBox="0 0 256 256" version="1.1"
                                ...
                                <g>
                                    <path
                                        ...
                                        fill="#8B5CF6" y="0"></path>
                                </g>
                            </svg>
                        </a>

                        <a className="socialicon linkedin" href="" target="_blank" rel="author">
                            <svg className="linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 24 24"
                                fill="#8B5CF6" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a className="socialicon codeforces" href="" target="_blank" rel="author">
                            <svg className="codeforces-icon" xmlns="http://www.w3.org/2000/svg" viewBox="5 0 14 19"
                                width="100" height="100">
                                <g>
                                    <rect className="red" x="15" width="2" height="6.5" rx="0.7" y="0" fill="#8B5CF6" />
                                    <rect className="blue" x="12" width="2" height="6.5" rx="0.7" y="0" fill="#8B5CF6" />
                                    <rect className="yellow" x="9" width="2" height="6.5" rx="0.7" y="0" fill="#8B5CF6" />
                                </g>
                            </svg>
                        </a>

                        <a className="socialicon kaggle" href="" target="_blank" rel="author">
                            <i className="fab fa-kaggle"></i>
                        </a>

                        <a className="socialicon instagram" href="" target="_blank" rel="author">
